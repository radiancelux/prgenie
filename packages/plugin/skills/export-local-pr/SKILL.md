...
description: Halt listen loops and open a GitHub pull request at origin from a PR Genie local PR. Use only when the developer explicitly wants to publish — /export-local-pr, Export to GitHub, or asks to push this loop.
