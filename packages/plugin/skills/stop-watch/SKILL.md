...
The developer is ending local review listen loops (implementor inbox and reviewer queue).
...
3. Confirm: watch is `halted reason=stop`. Do not `git push`. Do not `gh pr create`.
